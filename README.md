...
By default the HD stream is used. To swap to the SD stream add `stream = "subStream"` to the `***REMOVED***` config. You may also need to use `h264` format while using the SD stream.
